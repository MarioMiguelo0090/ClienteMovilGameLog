...
import com.example.gamelog.databinding.ActivityEdicionPerfilBinding;

public class EdicionPerfil extends AppCompatActivity {
    ActivityEdicionPerfilBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        binding=ActivityEdicionPerfilBinding.inflate(getLayoutInflater());
    ...
    private void guardarCambiosPerfil(){
        if(verificarCampos()){
            editarPerfilEnServidor();
        }
    }

    private void editarPerfilEnServidor(){
